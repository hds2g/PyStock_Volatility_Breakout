...
telegram_token = parser.get('account', 'telegram_token')
telegram_id = parser.get('account', 'telegram_id')
...
def send_telegram_message(text):
    bot.sendMessage(chat_id=telegram_id, text=text)
...
if __name__ == '__main__':
    try:
        ...
        # temp 20210319
        total_cash = total_cash-10000000  # 레버리지 ETF/ETN 예탁금
        print(total_cash)
